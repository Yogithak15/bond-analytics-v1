  ...
  return (
    <nav className="sidebar">
      ...
      {/* <div className="sb-footer">
        <div className="sb-item" id="sni-ref" onClick={() => window.navigate?.('ref')}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
          <span className="sb-item-label">Data Docs</span>
          <span className="sb-badge sb-badge-gray">DOCS</span>
        </div>
        <div className="sb-item" style={{cursor:'default'}}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4.03 3 9 3s9-1.34 9-3V5"/><path d="M12 12h9"/></svg>
          <span className="sb-item-label">Data Explorer</span>
          <span className="sb-badge sb-badge-teal">BI</span>
          <span className="sb-item-arr">
