  ...
  return (
    <nav className="sidebar">
      ...
      <div className="sb-nav">
        <div className="sb-item on" id="sni-dash" data-tip="Dashboard" onClick={() => window.navigate('dash')}>
        ...
        <div className="sb-item" id="sni-catalog" data-tip="Dataset Catalog" onClick={() => window.navigate('catalog')}>
