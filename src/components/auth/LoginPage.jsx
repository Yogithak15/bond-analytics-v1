    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          height: 480,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(37,87,167,0.18) 0%, transparent 70%)',
          pointerEvents: 'none',
        }} />
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, position: 'relative' }}>
          ...
          <span style={{ fontSize: 17, fontWeight: 700, color: '#f0f4ff', letterSpacing: '-0.2px' }}>
            BondBulls
          </span>
        </div>
        ...
        <div style={{ position: 'relative' }}>
          ...
          {/* <div style={{ display: 'flex', gap: 12, marginTop: 36, flexWrap: 'wrap' }}>
            {[
              { label: 'G-Sec', value: '₹ 112 L Cr' },
              { label: 'SDL', value: '₹ 52 L Cr' },
              { label: 'Corp Bonds', value: '₹ 46 L Cr' },
            ].map(s => (
              <div key={s.label} style={{
                background: 'rgba(37,87,167,0.12)',
                border: '1px solid rgba(37,87,167,0.25)',
                borderRadius: 8,
                padding: '8px 14px',
              }}>
                <div style={{ fontSize: 11, color: '#6080a8', marginBottom: 2 }}>{s.label}</div>
                <div style={{ fontSize: 13, fontWeight: 600, color: '#a8c0e0' }}>{s.value}</div>
              </div>
            ))}
          </div> */}
        </div>
        ...
        {/* Footer */}
        <div style={{ fontSize: 12, color: '#3a5070', position: 'relative' }}>
          © 2026 BondBulls Analytics · Powered by RBI &amp; SEBI data
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              style={{
                ...
                background: loading
                  ? 'rgba(37,87,167,0.4)'
                  : 'linear-gradient(135deg, #2557a7, #1a4285)',
                color: '#fff',
                border: 'none',
                borderRadius: 8,
                fontSize: 14,
